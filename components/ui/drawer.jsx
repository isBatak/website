...
export const DrawerTitle = forwardRef<HTMLHeadingElement, ChakraDrawer.TitleProps>(function DrawerTitle(props, ref) {
  return (
...
export const DrawerDescription = forwardRef<HTMLParagraphElement, ChakraDrawer.DescriptionProps>(
